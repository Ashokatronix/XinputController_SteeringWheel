...
const int delayBetweenHIDReports = 1;
...
const int lookupTableSteering[21] = { 0, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000};
*/
// const int lookupTableSteering[21] = { 0, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000};
...
*/
    if (steering_change > significant_change_threshold) {
      // Map analog reading from 0 ~ 4095 to 32737 ~ 0 for use as an axis reading
      SteeringAdjustedValue = map(SteeringVal, 0, 4095, -32768, 32767);
